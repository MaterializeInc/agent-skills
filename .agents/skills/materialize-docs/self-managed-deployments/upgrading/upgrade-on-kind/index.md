...
<div class="highlight"><pre tabindex="0" class="chroma"><code class="language-shell" data-lang="shell"><span class="line"><span class="cl"><span class="nv">mz_version</span><span class="o">=</span>v26.39.0
...
</span></span></span><span class="line hl"><span class="cl"><span class="se"></span>--version v26.39.0 <span class="se">\
...
<table>
  ...
  <tbody>
      <tr>
          ...
          <td>Update the version to the new version. This should be the same as the operator version: <code>v26.39.0</code>. Updating this field automatically triggers a rollout.</td>
      </tr>
      <tr>
...
</span></span></span><span class="line"><span class="cl"><span class="w">  </span><span class="nt">environmentdImageRef</span><span class="p">:</span><span class="w"> </span><span class="l">materialize/environmentd:v26.39.0</span><span class="w"> </span><span class="c"># Update version</span><span class="w">
...
<table>
  ...
  <tbody>
      <tr>
          <td><code>environmentdImageRef</code></td>
          <td>Update the version to the new version. This should be the same as the operator version: <code>v26.39.0</code>.</td>
      </tr>
      <tr>
