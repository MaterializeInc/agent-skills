...
7. **Confirm success** in one short sentence and offer a follow-up. Example: *"You're connected as `my_dev_agent`. Try `/mcp-environment-analysis what's the health of my environment?` next."*
