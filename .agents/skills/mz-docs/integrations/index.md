...
## ADBC (Arrow Database Connectivity)
  ...
  <div class="warning">
    ...
    <a href="/releases#release-notes"><strong>v26.40</strong></a>.
...
`mz-docs` skill globally, Claude Code may ask to approve reads each
time the skill opens a new documentation subdirectory.

To stop these prompts, grant read access to the `mz-docs` skill in
